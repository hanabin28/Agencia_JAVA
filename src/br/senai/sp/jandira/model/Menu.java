            ...
            switch (optionClient) {
                ...
                case 5:
                    ...
                    if (contaSaque != null){
                        ...
                        contaSaque.validarSaque(valorSaque);
                ...
                case 6:
                    ...
                    if (contaTransferencia!=null){
                        System.out.println("Informe o CPF do beneficiário: ");
                        long cpfBeneficiario = scanner.nextLong();
                        scanner.nextLine();

                        Conta contaBeneficiario = referenciaConta.pesquisarConta(cpfBeneficiario);

                        if (contaBeneficiario!=null){
                            System.out.println("Insira o valor da transferência bancária: ");
                            double valorTransferencia = scanner.nextDouble();
                            scanner.nextLine();
                            contaTransferencia.validarTransferencia(valorTransferencia);
